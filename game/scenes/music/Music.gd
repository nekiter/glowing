...
export var transition_out_duration = 1.00
export var transition_in_duration = 1.00
...
func fade_out(stream_player):
	...
	tween_out.interpolate_property(stream_player, "volume_db", 0, -80, transition_out_duration, transition_type, Tween.EASE_IN, 0)
	tween_out.start()
...
func fade_in(stream_player, seek):
	if !stream_player.playing:
		...
		tween_in.interpolate_property(stream_player, "volume_db", -80, 0, transition_in_duration, transition_type, Tween.EASE_IN, 0)
		tween_in.start()
